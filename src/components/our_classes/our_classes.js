...
import team_kata from "../../assets/img/team_kata.png"
import team_kumite from "../../assets/img/teamkumite.png"
import kumite from "../../assets/img/kumite.png"
        ...
        <div className="container mt-5">
            ...
            <div className="row text-center mt-5" style={{marginBottom:"100px"}}>
                ...
                <div className="col-md-4 col-sm-6 margin_bott">
                    ...
                    <figure><img src={kumite} alt={{}} style={{width:"200px",height:"200px"}} /></figure>
                ...
                <div className="col-md-4 col-sm-6 mt-4">
                    <div className="our_yoga">
                    <figure><img src={team_kumite} alt={{}}style={{width:"200px",height:"200px"}} /></figure>
                ...
                <div className="col-md-4 col-sm-6 mt-4">
                    <div className="our_yoga">
                    <figure><img src={team_kata} alt={{}} style={{width:"200px",height:"200px"}} /></figure>
                ...
                <div className="col-md-4 offset-md-4 col-sm-6 mt-4  margin_top">
                    <div className="our_yoga">
                    <figure><img src={kata} alt={{}} style={{width:"200px",height:"200px"}} /></figure>
