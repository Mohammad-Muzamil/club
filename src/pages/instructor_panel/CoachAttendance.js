  ...
  const isMobilerow = useMediaQuery({ maxWidth:767 });
    return(
        <tr style={{marginBottom:"0px"}}>
            ...
            <td ><input style={{height:"20px"}} type='checkBox'/></td>
        </tr>
    )
}
        ...
        <div className="content">
          ...
          <div className="col-sm-12 col-12">
                        <div className=" rounded h-100 p-4">
                            <div className='d-flex justify-content-between w-100 flex-column flex-lg-row flex-xl-row'>
                                <h3 className="mb-4 text-primary">Player Attendance</h3>
                                <button className='btn btn-primary' style={{width:"100px", height:"40px"}}>Select All</button>
                            </div>
